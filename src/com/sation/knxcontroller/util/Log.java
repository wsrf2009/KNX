...
/**
 * Log Wrapper android.util.Log API for sending log output.
 */
public class Log {
	protected static final boolean DEBUG = true;
	protected static final String TAG = "EHOME";
	...
	protected static String buildMessage(String msg) {
		...
		return new StringBuilder().append(ste.getClassName()).append(".")
				.append(ste.getMethodName()).append("(): ").append(msg)
				.toString();
	}
}
