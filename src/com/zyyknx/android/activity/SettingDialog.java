	...
	public void Show() {
		...
		settingKNXConnect.setOnSettingButtonClickListener(new onSettingButtonClickListener() {
			...
			public void onSettingButtonClick() { 
				...
				Spinner spinner = (Spinner) view.findViewById(R.id.spinnerMode);
		        spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
		            @Override
		            public void onItemSelected(AdapterView<?> parent, View view, 
		                    int pos, long id) { 
		                String[] mode = mContext.getResources().getStringArray(R.array.Mode);
		                //Toast.makeText(mContext, "你点击的是:"+ mode[pos], 2000).show();
		                
		                SharedPreferences.Editor editor = settings.edit(); 
						editor.putInt(ZyyKNXConstant.KNX_SOCKET_MODE, Integer.valueOf(pos + 1));
						editor.commit(); 
		            }
		            @Override
