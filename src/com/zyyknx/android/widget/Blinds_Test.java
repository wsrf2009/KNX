...
/*https://github.com/zwxyswd/android-NumberPicker*/
public class Blinds_Test extends LinearLayout {
     ...
     * @hide
     */
    public static final Blinds_Test.Formatter TWO_DIGIT_FORMATTER = new Blinds_Test.Formatter() {
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(Blinds_Test picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(Blinds_Test view, int scrollState);
    }
     ...
     */
    public Blinds_Test(Context context) {
        this(context, null);
    }
     ...
     */
    public Blinds_Test(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        attributesArray.recycle();
    ...
    private int resolveSizeAndStateRespectingMinSize(int minSize, int measuredSize,
        ...
        if (minSize != SIZE_UNSPECIFIED) {
            ...
            return resolveSizeAndState2(desiredWidth, measureSpec, 0);
        } else {
            return measuredSize;
        }
    }
    ...
    private int resolveSizeAndState2(int size, int measureSpec, int childMeasuredState) {
        ...
        return result | (childMeasuredState & size);
    }
