...
public class SlidingToggleSwitchView extends ControlView implements OnClickListener {
	...
	public SlidingToggleSwitchView(Context context, AttributeSet attrs) {
		...
		leftButtonText = a.getString(R.styleable.SlidingToggleSwitch_leftButtonText);
		rightButtonText = a.getString(R.styleable.SlidingToggleSwitch_rightButtonText);
		textColor = a.getColor(R.styleable.SlidingToggleSwitch_android_textColor, android.R.color.white);
		sliderBackground = a.getDrawable(R.styleable.SlidingToggleSwitch_sliderBackground);
		buttonBackground = a.getDrawable(R.styleable.SlidingToggleSwitch_slidingButtonBackground);
		...
		if (sliderBackground == null) {
			this.setBackgroundDrawable(getResources().getDrawable(R.drawable.toggle_frame));
		} else {
