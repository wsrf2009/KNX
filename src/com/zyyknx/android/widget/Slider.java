...
import com.zyyknx.android.util.ImageUtil;
import com.zyyknx.android.util.NumberFormat;
import com.zyyknx.android.widget.seekbar.ORSeekBar;
...
public class Slider extends ControlView implements ORSeekBar.OnSeekBarChangeListener {
	...
	private void initControl(final KNXSlider mKNXSlider) {
		...
		if (mKNXSlider.getRightImage() != null) {
			maxTrackDrawable = ImageUtil.createFromPathQuietly(ZyyKNXConstant.FILE_FOLDER_PATH + mKNXSlider.getRightImage());
		} else {
		...
		if (mKNXSlider.getLeftImage() != null) {
			minTrackDrawable = ImageUtil.createFromPathQuietly(ZyyKNXConstant.FILE_FOLDER_PATH + mKNXSlider.getLeftImage());
		}else {
		...
		if (mKNXSlider.getSliderImage() != null) {
			Drawable thumbDrawable = ImageUtil.createFromPathQuietly(ZyyKNXConstant.FILE_FOLDER_PATH + mKNXSlider.getSliderImage());
