...
import com.zyyknx.android.dataacess.SQLiteDataInitializer;
import com.zyyknx.android.dataacess.SQLiteDataInitializingHelper;
import com.zyyknx.android.PreferenceConstants;
...
public class DefaultSQLiteOpenHelper implements SQLiteInitializer {
	...
	public SQLiteDatabase openDatabase(Context context, String databaseName) {
		settings = context.getSharedPreferences(ZyyKNXConstant.SETTING_FILE, android.content.Context.MODE_PRIVATE);
		int databaseVersion = settings.getInt(PreferenceConstants.DATABASE_VERSION, 0);
		if (databaseVersion != DBConfig.DATABASE_VERSION) {
			...
			editor.putInt(PreferenceConstants.DATABASE_VERSION,
	...
	public boolean isInitializeData(String databaseName) {
		return ZyyKNXConstant.INITIALIZE_DATABASE_DATA;
	}
